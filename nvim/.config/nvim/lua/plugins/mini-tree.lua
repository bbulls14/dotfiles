return {
 ...
 config = function(_, opts)
  -- Set up mini.files with nvim-web-devicons
  require("mini.files").setup(vim.tbl_deep_extend("force", opts, {
    icons = {
      -- Use nvim-web-devicons for icons
      provider = "devicons",
    },
  }))

  -- Load Git integration (optional)
